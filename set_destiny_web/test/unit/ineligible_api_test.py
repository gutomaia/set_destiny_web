...
from set_destiny_web.risk.ineligible import ineligible as real_ineligible

import json


class IneligibleApiTest(ScoreRulesSpec, TestCase):

    def spy_ineligible(self, scores, **kwargs):
        self.score = real_ineligible(scores, **kwargs)
        return self.score
    ...
    def setUp(self):
        ...
        self.score = {}
        self.score_patch = patch('set_destiny_web.api.profile.ineligible', wraps=self.spy_ineligible)
    ...
    def __getattribute__(self, name):
        ...
        return super(IneligibleApiTest, self).__getattribute__(name)
